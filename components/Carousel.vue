<template>
  <div class="carousel ">
    ...
    <div class="project-info">    
      <h4 class="subtitle"> {{currentProject.title}}</h4>
    ...
    <p @click="shiftPanelsBy(mode.val)" class="button--green slider-button"> 
    ...
    <br><br>
    <div>
      <p @click="toggleMode" class="button--grey"> 
        {{mode.name}}
      </p>
      <p @click="shuffle" class="button--grey"> 
        SHUFFLE! <i class="far fa-smile"></i>
      </p>
    </div>
    <br> <br>
